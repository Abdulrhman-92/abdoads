...
$pricing_id = Functions:: get_pricing_id_abdoads(); // currnte pricing id
$home_pricing =  Functions:: abdoads_settings("home_business_plan_id") ; //this is the home pricing 
...
if ($member->has_membership()){
    ...
    ?>
                                        ...
                                        <?php 
                                            if (!empty($pricing_options)) {
                                                foreach ($pricing_options as $option) {
                                                    ...
                                                    if ($home_pricing == $pricing_id[0]) {
                                                        
                                                        if ($option->ID == $home_pricing) {
        ...
        ------------->
        <br>
        <?php if ($home_pricing == $pricing_id[0]) {?>
