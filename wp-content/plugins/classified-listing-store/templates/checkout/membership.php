            ...
            <tr>
                ...
                <td class="rtcl-pricing-price text-right"
                    data-label="<?php printf(__('Price [%s %s]:', 'classified-listing-store'),
                        Functions::get_currency(true),
                        Functions::get_currency_symbol(null, true)); ?>"><?php echo Functions::get_formatted_amount($price, true); ?> 
                </td>
...
<table  class="rtcl-responsive-table rtcl-pricing-options form-group table table-hover table-stripped table-bordered rtcl-membership-pricing-options">

    <tr>
    
        <td class="rtcl-pricing-price text-left">
            <select name="select-cat" required> 
